...
| R12 | Introduzir multiplayer antes de a base do jogo guardar dados de forma estável pode aumentar muito a complexidade técnica | Média | Alto | Adiar SignalR até a base estar estável; quando avançar, manter a lógica de salas, timers, palpites e reconnects no backend. |
